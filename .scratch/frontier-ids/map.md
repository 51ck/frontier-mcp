...
- [T40 — Legacy Tickets and migrate_effort under uncoordinated minting](issues/06-T40-legacy-tickets-and-migrate-effort-under-uncoordi.md) — Superseded on minting by T62; an existing id is always preserved, `rename` goes, preview names unminted Tickets by handle through reference-style links, and a foreign frontmatter fence is quarantined into the body rather than imported
