...
- Root-owned files: [CONTEXT.md](./CONTEXT.md) (glossary), [docs/adr/](./docs/adr/) (decision records),
  ...
  FrontierMCP consumer friction), [README.md](./README.md) (the package's public face — install, pinning,
...
- `.scratch/` holds this repo's own Efforts, in the same layout FrontierMCP serves — currently
